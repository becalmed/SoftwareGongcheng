...
public class SysActivityController {
    ...
    @PreAuthorize("@el.check('sysActivity:list')")
    public ResponseEntity<PageResult<SysActivityDto>> querySysActivity(SysActivityQueryCriteria criteria, Pageable pageable){
        return new ResponseEntity<>(sysActivityService.queryAll(criteria,pageable),HttpStatus.OK);
    }
    ...
    public ResponseEntity<Object> deleteSysActivity(@RequestBody Integer[] ids) {
